...
public class IndexController {
	...
	带参数：http://localhost:8080/index/get?name=titaniume
	带参数有中文：http://localhost:8080/index/get?name=张三
	url测试：http://localhost:8080/index/get/1/titaniume
	url测试：http://localhost:8080/index/get/1/张三
	 */
