 ...
 *  实现多账号，轮询发送
 * @author titaniume
 * 2017年12月12日上午12:37:33
 *
 */
@Configuration
@EnableConfigurationProperties(MailProperties.class)
public class TitaniumeJavaMailSenderImpl extends JavaMailSenderImpl implements JavaMailSender {
	...
	public TitaniumeJavaMailSenderImpl(MailProperties properties) {
