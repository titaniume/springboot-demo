...
import com.titaniume.springboot.component.TitaniumeJavaMailComponent;
...
public class ApiController {
	...
	@Autowired
	private TitaniumeJavaMailComponent titaniumeJavaMailComponent;
	...
	public String mail(String email) {
		titaniumeJavaMailComponent.sendMail(email);
		return "success";
	}
}
